  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Rules and preset automations run on a schedule in the background. Pause everything here.
          Discord notifications live in the Discord section.
        </CardDescription>
      </CardHeader>
      <CardContent>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          set page, hit “Copy YAML” and paste it here. Also available straight from any
          poster picker’s YAML tab.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <MediuxImportPanel />
